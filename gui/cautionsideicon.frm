...
dialog dlgMain
{
	...
	button btnIcon
	{
		...
		surface_file 	= "CautionSideIcon.srf";
		surface_up 	= "srfBtnCautionUp";
		surface_down 	= "srfBtnCautionDown";
		surface_focus 	= "srfBtnCautionFocus";
		surface_disable = "srfBtnCautionDown";
	}
}
